...
function archiveCopy(slug){if(slug==='pequenos-mamiferos')return{title:'Pequenos mamíferos.',intro:'Conheça espécies e variedades de pequenos mamíferos na AgroNexus™.'};if(slug==='repteis')return{title:'Répteis.',intro:'Conheça espécies e referências do universo de répteis AgroNexus™.'};return null}
export default function AgroNexusWorldExperience({slug,departmentSlug=null}){
  if(slug==='corais'||(slug==='aquarismo'&&(!departmentSlug||departmentSlug==='marinho')))return <AgroNexusMarineTunnel/>
